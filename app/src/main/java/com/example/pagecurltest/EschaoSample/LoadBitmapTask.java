...
public final class LoadBitmapTask implements Runnable {
    ...
    private LoadBitmapTask(Context context) {
        ...
        mPortraitBGs = new int[][] {
            new int[] {R.drawable.bear, R.drawable.camels, R.drawable.cheetah,
                R.drawable.giraffe, R.drawable.gorilla, R.drawable.leapord,
                R.drawable.lion, R.drawable.lion2, R.drawable.orangutan,
                R.drawable.penguin},
            new int[] {R.drawable.shark, R.drawable.tiger, R.drawable.zebra,
                R.drawable.kittens, R.drawable.fox, R.drawable.rabbit,
                R.drawable.seal, R.drawable.parrot, R.drawable.koala,
                R.drawable.camel2},
            new int[] {R.drawable.squirrel, R.drawable.rabbit2,
                R.drawable.bird, R.drawable.lion3,
                R.drawable.monkey, R.drawable.eagle,
                R.drawable.peacock, R.drawable.fox2,
                R.drawable.dog, R.drawable.zebra2}
        };
//        mPortraitBGs = new int[][] {
