...
import com.example.pagecurltest.EschaoPageFlip.PageFlip;
import com.example.pagecurltest.EschaoPageFlip.PageFlipException;
...
public class PageFlipView extends GLSurfaceView implements Renderer {
    ...
    private void init(Context context) {
        ...
        mPageFlip.setSemiPerimeterRatio(0.8f)
            .setShadowColorOfFoldBase(0.01f, 0.5f, 0.01f, 0.1f)
            .setShadowColorOfFoldEdges(0.01f, 0.5f, 0.01f, 0.1f)
            .setShadowWidthOfFoldEdges(5, 10, 0.3f)
            .setShadowWidthOfFoldBase(5, 20, 0.4f)
